...
export const library: Record<SubjectId, string[]> = {
  mathematics: [
    'Школа России — Математика. 3 класс. Часть 1',
    'Школа России — Математика. 3 класс. Часть 2',
    'Школа России — Математика. 3 класс. Рабочая тетрадь',
    'Школа России — Математика и конструирование. 3 класс',
    'Памятка: сложение столбиком',
    'Схемы к задачам',
    'Рабочие листы прошлых уроков',
  ],
